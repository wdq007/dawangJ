...
public class JavaDBDemo1 {
    ...
    private static String dbUrl = "jdbc:derby:daotest;create=false";
    ...
    public void readData(){
        try(Connection connection = DriverManager.getConnection(dbUrl);
        PreparedStatement preparedStatement = connection.prepareStatement(READ_DATA_SQL);
